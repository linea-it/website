...
<div class="clearboth"></div>
	<div id="content" class="conteudo delete page" role="main">
			...
			if ( !empty($_POST)) {
		        ...
		        $sql = "DELETE from bootcamp WHERE id = ?";
		        $q = $pdo->prepare($sql);
		        $q->execute(array($id));

		        // Inserindo LOG da operação no banco
		        $sql_log = "INSERT INTO log (wp_username, datetime, action, page, resumo) VALUES (?, now(), 'DELETE', 'BOOTCAMP', ?)";
		    ...
		    <section>
		        <h1>Apagar</h1>
		            ...
		            <form action="<?php echo get_bloginfo('template_url') . '/bootcamp_delete.php'; ?>" method="post">
						<div class="grupo-input">
		                  ...
		                  <a class="btn" href="/bootcamp/">Não</a>
		                </div>
		            </form>
		    </section>
		    </main>
