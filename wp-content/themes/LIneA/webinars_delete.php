...
<div class="clearboth"></div>
	<div id="content" class="conteudo delete page" role="main">
			...
			if ( !empty($_POST)) {
		        ...
		        $sql_log = "INSERT INTO log (wp_username, datetime, action, page, resumo) VALUES (?, now(), 'DELETE', 'WEBINARS', ?)";
		    ...
		    <section>
		        <h1>Apagar</h1>
		            ...
		            <form action="<?php echo get_bloginfo('template_url') . '/webinars_delete.php'; ?>" method="post">
						<div class="grupo-input">
		                  ...
		                  <a class="btn" href="/seminarios/">Não</a>
		                </div>
		            </form>
		    </section>
		    </main>
