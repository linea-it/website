...
<div class="clearboth"></div>
	<div id="content" class="conteudo webinars" role="main">
		...
		<?php
	    	...
	    	$sql = 'SELECT * FROM hotspot ORDER BY data DESC';
	    	...
	    	echo '<p></p>';
	       	...
	       	function showWebinarSumary($row, $login) {
	       		...
	       		// icones
	       		echo '<span class="group-icon"><a class="icon ' . $login . '" href="'. get_bloginfo('template_url') .'/hotspot_update.php?id='. $row['id'] .'"><img src="' . get_bloginfo('template_url') . '/imagens/ic_create_white_24dp_2x.png" alt="Edit icon"/></a><a class="icon ' . $login . '" href="'. get_bloginfo('template_url') .'/hotspot_delete.php?id='. $row['id'] .'"><img src="' . get_bloginfo('template_url') . '/imagens/ic_remove_circle_outline_white_24dp_2x.png" alt="Remove icon"/></a></span>';
	       		// imagem
