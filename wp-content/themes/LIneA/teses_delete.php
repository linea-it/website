...
<div class="clearboth"></div>
    <div id="content" class="conteudo delete page" role="main">
            ...
            if ( !empty($_POST)) {
                ...
                $sql_log = "INSERT INTO log (wp_username, datetime, action, page, resumo) VALUES (?, now(), 'DELETE', 'TESES', ?)";
            ...
            <section>
                <h1>Apagar</h1>
                    ...
                    <form action="<?php echo get_bloginfo('template_url') . '/teses_delete.php'; ?>" method="post">
                        ...
                        <div class="form-actions">
                            ...
                            <a class="btn" href="/new-teses/">Não</a>
                        </div>
                    </form>
            </section>
            </main>
