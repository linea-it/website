<?php
/**
 * Template Name: Estatistica de Ticket 2019
 *
 * @package WordPress
...
<?php get_sidebar(); ?>
<div class="breadcrumb"><a href="<?php bloginfo('url'); ?>">LIneA</a> » <a href="<?php bloginfo('url'); ?>/Ticket/" rel="category tag">Estatistica de Ticket - 2019</a></div>
<div class="clearboth"></div> 
  <div class="conteudo estatistica_ticket"  role="main">
     <h1>Relatório de Estatísticas Tickets - 2019</h1>  
     <div class="content">
  <div class="tabs-content">
    <div class="tabs-menu clearfix">
      <ul>
        <li><a class="active-tab-menu" href="#" data-tab="tab1">Jan 2019</a></li>
        <li><a href="#" data-tab="tab2">Fev 2019</a></li>
        <li><a href="#" data-tab="tab3">Mar 2019</a></li>
        <li><a href="#" data-tab="tab4">Abr 2019</a></li>
        <li><a href="#" data-tab="tab5">Mai 2019</a></li>
        <li><a href="#" data-tab="tab6">Jun 2019</a></li>
        <li><a href="#" data-tab="tab7">Jul 2019</a></li>
        <li><a href="#" data-tab="tab8">Ago 2019</a></li>
        <li><a href="#" data-tab="tab9">Set 2019</a></li>
        <li><a href="#" data-tab="tab10">Out 2019</a></li>
        <li><a href="#" data-tab="tab11">Nov 2019</a></li>
        <li><a href="#" data-tab="tab12">Dez 2019</a></li>
      </ul>
    </div> <!-- tabs-menu -->
