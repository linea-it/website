    ...
    <div id="content" class="conteudo update page" role="main">
            ...
            if ( !empty($_POST)) {
                ...
                if ($valid) {
                    ...
                    $sql_log = "INSERT INTO log (wp_username, datetime, action, page, resumo) VALUES (?, now(), 'UPDATE', 'TESES', ?)";
            ...
            <section>
                <h1>Editar</h1>
                    ...
                    <form action="<?php echo get_bloginfo('template_url') . '/teses_update.php?id=' . $id ?>" method="post" enctype="multipart/form-data">
                        <!-- Autor -->
