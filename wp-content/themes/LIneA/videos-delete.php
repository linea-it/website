...
<div class="clearboth"></div>
	<div id="content" class="conteudo delete page" role="main">
          ...
          $pdo->setAttribute( PDO::ATTR_EMULATE_PREPARES, false );
	        ...
	        $sql_log = "INSERT INTO log (wp_username, datetime, action, page, resumo) VALUES (?, now(), 'DELETE', 'VIDEOS', ?)";
		    ...
		    <section>
		        <h1>Apagar</h1>
		            ...
		            <form action="<?php echo get_bloginfo('template_url') . '/videos-delete.php'; ?>" method="post">
