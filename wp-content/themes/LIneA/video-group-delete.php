...
<div class="clearboth"></div>
	<div id="content" class="conteudo delete page" role="main">
          ...
          $pdo->setAttribute( PDO::ATTR_EMULATE_PREPARES, false );
	        $sql = "DELETE from video_grupos WHERE id = ?";
	        $q = $pdo->prepare($sql);
	        $q->execute(array($id));

	        // Inserindo LOG da operação no banco
	        $sql_log = "INSERT INTO log (wp_username, datetime, action, page, resumo) VALUES (?, now(), 'DELETE', 'VIDEOS-CATEGORIA', ?)";
		    ...
		    <section>
		        <h1>Apagar</h1>
		            ...
		            <form action="<?php echo get_bloginfo('template_url') . '/video-group-delete.php'; ?>" method="post">
						<div class="grupo-input">
		                  ...
		                  <a class="btn" href="/060-divulgacao/videos/">Não</a>
		                </div>
		            </form>
		    </section>
		    </main>
