...
if ($nationality == 'Brazillian'){
        $conteudo ="<div class='control-group'>
                     ...
                     <div class='control-group'>
                        <label class='control-label' style='text-align:right;'>Organ :</label>
                        <div class='input'>                                                         
    ...
    <div class="container" style="margin-top: 100px;">
      <div class="panel panel-default">
            <div class="page-header">
               <h3>User Registered<a href="http://webdev.linea.gov.br/bootstrap/search/search.php" target="_blank" class="lupa"><span class="glyphicon glyphicon-search"></span></a></h3>
            ...
            <div>
               ...
               <div>
                  ...
                  <!-- Text input-->
                  <div class="control-group">
                     <label class="control-label" style="text-align:right;">Telephone:</label>

                     <div class="input">
                      <label id='label_telefone' style="text-align:right;"><?php echo $telefone; ?></label><input id='input_telefone' name='input_telefone'  type="text" class="form-control escondido" style="width:150px;display:inline;"><a href='#' style='margin-left:10px;font-style:italic;'><span id="edit_telefone" style="color:#000;" class="glyphicon glyphicon-pencil"></span></a>
                  ...
                  <div class="control-group">
                     ...
                     <div class="input">
                      ...
                      <label id='label_celular' style="text-align:right;"><?php echo $celular; ?></label><input id='input_celular' name='input_celular'  type="text" class="form-control escondido" style="width:150px;display:inline;"><a href='#' style='margin-left:10px;font-style:italic;'><span id="edit_celular" style="color:#000;" class="glyphicon glyphicon-pencil"></span></a>
                  ...
                  <div class="control-group">
                     ...
                     <div class="input">
                        <label id='label_user' style="text-align:right;"><?php echo $user_for_linea; ?></label><input id='input_user' name='input_user'  type="text" class="form-control escondido" style="width:150px;display:inline;"><span >@linea.gov.br</span>  <a href='#' style='margin-left:10px;font-style:italic;'><span id="edit" style="color:#000;" class="glyphicon glyphicon-pencil"></span></a>
<!--a href='#' id='cancel_edit'  class='escondido' style='margin-left:10px;font-style:italic;'>Cancel </a-->
      ...
      <label class="control-label" style="text-align:right; ">Project:</label>
          <?php
              ...
              <!-- Multiple Checkboxes -->
          <ul id="myTab" class="nav nav-tabs" role="tablist" style="width:1110px;margin-left:50px;margin-bottom:30px;">
            <li class="active">
  ...
  <?php
    ...
    <br><br>
           ...
           <div class="quadrado" >
             <label class="control-label" style="margin-top:-10px;margin: 0px 200px 0px -20px;">Notice :</label>
                     <div id="send_ticket"   >
                        <label class="radio" style="margin-bottom:-10px;display:inline-block;margin: 0px 0px 0px -25px;" >
                        <input name="send_ticket" id="ticket" value="ticket"  type="checkbox" style="display:inline;" ><span class="glyphicon glyphicon-tags">  Send a ticket.</span></label>
                     </div>
                     <div id="send_user" >
                        <label class="radio"  style="margin: 0px 0px 0px -25px;">  
                        <input name="send_user" id="user" value="user" type="checkbox" disabled style="display:inline;"><span class="glyphicon glyphicon-user">  Send an email for <?php echo $nome; ?>. </span></label>
                     </div>
          </div>
          ...
          <div class="control-group" >
                     <label class="control-label" style="text-align:right;">Date of registration :</label>
                     <div class="input">
          ...
          <div class="control-group" style="margin-bottom:20px;">
                    ...
                    <div id="active" class="input"  style="margin-bottom:-10px;display:inline-block;">
                        <label class="radio" >
                        <input name="change_status" id="status" value="Ativo"  type="radio" style="display:inline;" <?php if($status_c =='Ativo'){ echo "checked"; } ?>>Ativo</label>
                     </div>

                     <div id="inactive" class="input" style="type:display:inline-block;margin-left:20px;margin-bottom:20px;">
                        <label class="radio" >  
                        <input name="change_status" id="status" value="Inativo" type="radio" style="display:inline;" <?php if($status_c =='Inativo'){ echo "checked"; } ?>>Inativo</label>
                     </div>
             ...
             <div id="datanotification"></div>
                  ...
                  <div class="control-group">
                     ...
                     <div class="input" style="margin-left: 900px;margin-top:-500px;">
                        <button id="submit" type="button" name="submit" class="btn btn-success" value="submit">Save</button>
