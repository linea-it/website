...
$assunto ="Registration confirmation";
//$mensagem .="<br><br><strong>Objetivo Principal:</strong>".$selecione4[$i];

$mensagemHTML="<html><head>    <style>
            body {
                margin: 0;
                padding: 0 170px;
                position:center;
        ...
        <table cellspacing='0'>
            <thead>
                <tr><th style='padding-left:160px;background-color:#727272;'>Registration Confirmation‏</th></tr>
            </thead>
			...
			Thank you for your registration.<br><br>
				We are providing registration to the system.<br>
			IT Team.  <br>
...
//$mensagem="conteudotesteemail - devel2"; //conteudo da mensagem
...
$headers .= "".$emailssender.$quebra_linha;
...
/*
    ...
    <tr>
                <td>Project:</td>
                <td><p class='align'>$project</p></td>
            </tr>
            <tr>
                <td>Objectives:</td>
                <td><p class='align'>$sObjectives</p></td>
            </tr>
            <tr>
                <td>Other objectives:</td>
                <td><p class='align'>$other</p></td>
            </tr>
            <tr>
                <td>Access:</td>
                <td><p class='align'>$sAccess</p></td>
            </tr>
            <tr>
                <td>Agenda LineA:</td>
                <td><p class='align'>$sAgendalinea</p></td>
            </tr>
            <tr>
                <td>Twiki:</td>
                <td><p class='align'>$sTwiki</p></td>
            </tr>
            <tr>
                <td>Email list:</td>
                <td><p class='align'>$sEmaillist </p></td>
            </tr>
...
mail($eu, $subject, $message, $headers, -f);

mail($para, $assunto, $mensagemHTML, $headers, -f);
