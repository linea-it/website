            ...
            <div>
                  ...
                  <!--div class="control-group" >
                     ...
                     <!--div id="br" style="display:none;margin-bottom:15px;display:none;margin-left:200px;" >
                        ...
                        <div id="estrangeiros">            
                           ...
                           <label class="control-label" style="text-align:right;">Passport:</label>
                           <div class="input">
                              <input class="form-control" name="passaport" placeholder="" id="passaport"   type="label" style="width:340px;display:inline;">
                      ...
                      <div id="estrangeiro_residente">


                        <label class="control-label" style="text-align:right;">Passport:</label>
                           <div class="input">
                              <input class="form-control" name="passaportr" placeholder="" id="passaportr"   type="label" style="width:340px;display:inline;">
                           </div><br />
                           
                           <label class="control-label" style="text-align:right;">CPF:</label>
                           <div class="input">
                           <input class="form-control" name="cpfr" placeholder="" id="cpfr"  type="label" style="width:340px;display:inline;">
               ...
               <div id="nacionalidade"></div>
                     ...
                     <div class="control-group"  >
                           ...
                           <label class="control-label" style="text-align:right;">Passaport:</label>
                           <div class="input">
                              <input class="form-control" name="passaportr" placeholder="" id="passaportr"  checked="checked" type="label" style="width:340px;display:inline;">
                           </div><br />
                           
                           <label class="control-label" style="text-align:right;">CPF:</label>
                           <div class="input">
                           <input class="form-control" name="cpfr" placeholder="" id="cpfr"  checked="checked" type="label" style="width:340px;display:inline;">
                           <input type="hidden" name="nationality" id="Foreign_Resident" value="Foreign Resident">
                  ...
                  <div class="control-group">
                     ...
                     <div class="input">
                        ...
                        <select id="position" name="position" class="form-control">
                           ...
                           <option value="Graduando">Undergraduate Student</option>
                           <option value="Mestrando">MSc. Student</option>
                           <option value="Pos-Doutorando">PhD. Student</option>
                           <!--option value="Posdoc">Post-Doc</option-->
                           <option value="Tecnologista">IT</option>
                           <option value="Cientista">Scientist</option>
                        </select>
                     </div>
                  </div>
                   <!-- Text input-->
...
<br />
                  <div class="control-group">
                     ...
                     <div class="input" style="margin:0px 0px 0px 500px;">
                        ...
                        <button type="button" id="cancel" name="cancel" class="btn btn-inverse" data-dismiss="modal">Cancel</button>
                     </div>
                  </div>
