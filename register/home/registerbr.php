...
<html >
   <head>
      ...
      <!--script src="http://ajax.googleapis.com/ajax/libs/jquery/1.11.0/jquery.min.js"></scripESTAVA DESCOMENTADOt-->
      ...
      <form class="form-horizontal" id="form1" action="" name="form1" method="post" style="margin-left:-65px;">
            ...
            <div>
               ...
               <div>
                  ...
                  <!-- Multiple Radios -->
                  <input type="hidden" name="nationality" id="brazillian" value="Brazillian" >
                  <div class="control-group">
                    <div id="br">
                        ...
                        <!--div id="linha" -->
                           ...
                           <div class="input">
                           <input class="form-control" name="cpf" placeholder="" id="cpf"  checked="checked" type="label" style="width:340px;display:inline;">
                           </div>
                        <br />
                           <label class="control-label" id="identify" style="text-align:right;">Identidade:</label>
                           <div class="input">
                              <input class="form-control" name="identity" placeholder="" id="identity" checked="checked" type="label" style="width:340px;display:inline;">
                           </div>
                        <br />
                           <label class="control-label" style="text-align:right;" >Orgão emissor:</label>
                           <div class="input">
                           <input class="form-control" name="organofconsultation" placeholder="" id="organofconsultation" checked="checked" type="label" style="width:340px;display:inline;">
                        </div>
                        <br/>
                           <label class="control-label" id="uf" style="text-align:right;">UF:</label>
                           <div class="input">
                           <input class="form-control" name="uf" placeholder="" id="uf" checked="checked" type="label" style="width:54px;display:inline;">
                        </div>
                        <!--/div-->
                     ...
                     <div id="passaporte" style="display:none;margin-bottom:10px;display:none;margin-left:130px;" >
                        <!--div id="linha"-->
                  ...
                  <!-- Text input-->
                  <div class="control-group">
                     <label class="control-label" style="text-align:right;margin-left:-20px;">Endereço:</label><br>
                  ...
                  <div id="linha">
                        <!--input id="address" name="address" placeholder="Address" class="input-xlarge" type="text"-->
                           ...
                           <input id="street" name="street"  placeholder=" " class="form-control" type="text" style="width:360px;display:inline;margin-bottom:5px;margin-left:74px;"><br />
                           ...
                           <input id="city" name="city"  placeholder="" class="form-control" type="text" style="width:260px;margin-bottom:5px;display:inline;margin-left:54px;"><br />
                           <label class="control-label" name="address"  style="text-align:right;display:inline;margin-right:-15px;margin-bottom:5px;">Caixa postal:</label>    
                           <input id="zipcode" name="zipcode"  placeholder="" class="form-control" type="text" style="width:260px;margin-left:15px;margin-bottom:5px;display:inline;"><br />
                           ...
                           <input id="state" name="state"  placeholder="" class="form-control" type="text" style="width:260px;margin-bottom:5px;display:inline;margin-left:52px;"><br/>
                           <!--label class="control-label" name="address"  style="text-align:right;display:inline;margin-right:-18px;margin-bottom:5px;">Pais:</label-->        
                           <input id="country" name="country"  placeholder="" class="form-control" type="hidden" value="Brasil" style="width:340px;margin-bottom:5px;display:inline;margin-left:18px;"><br /-->
                  ...
                  <div class="control-group">
                     ...
                     <div class="input">
                        ...
                        <input id="telephone" name="contacttelephone"  placeholder="ex:000 0000-0000" class="form-control" type="text" style="width:340px;display:inline;">
                  ...
                  <div class="control-group">
                     ...
                     <div class="input">
                        <!--input id="cellphone" name="cellphone" placeholder="Cell phone" class="input-xlarge" type="text"-->
                         <input id="celphone" name="cellphone"  placeholder="ex:000 0000-0000" class="form-control" type="text" style="width:340px;display:inline;">
                  ...
                  <!-- Select Basic -->
                  <div class="control-group">
                     <label class="control-label" style="text-align:right;">Posição:</label>
                     ...
                     <div class="input">
                        ...
                        <select id="position" name="position" class="form-control">
                           ...
                           <option value="Pos-Doutorando">Pós-Doutorando</option>
                           <option value="Tecnologista">Tecnologista</option>
                  ...
                  <div class="control-group">
                      <label class="control-label" style="text-align:right;" >E-mail para contato:</label>
                     <div class="input" >
            ...
            <!--div class="panel-group" id="accordion" style="margin-left:50px">
               ...
               <!-- perdido/div-->
                  ...
                  <div class="control-group">
                     ...
                     <div class="input" style="margin:0px 0px 0px 500px;">
                        <button id="submit" type="button" name="submit" class="btn btn-success" value="submit">Enviar</button>
                        <!--button id="cancel" name="cancel" class="btn btn-inverse">Cancel</button-->
                        <button type="button" id="cancel" name="cancel" class="btn btn-inverse" data-dismiss="modal">Cancelar</button>
                     </div>
                  </div>
