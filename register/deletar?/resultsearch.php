...
$time = strtotime($date);
 $datebirth = ($time === false) ? '0000-00-00' : date('d/m/Y ', $time);
  ...
  $telum = substr($telephone, 0, -10);
  $teldois = substr($telephone, 3, -7);
  $teltres = substr($telephone, 3, -1);
  ...
  $celum = substr($cell_phone, 0, -10);
  $celdois = substr($cell_phone, 3, -7);
  $celtres = substr($cell_phone, 3, -1);
   ...
   <body style="background-color: #bbbbbb; background-image: linear-gradient(to bottom, #000000, #bbbbbb 20%);  overflow-x:hidden;">
      ...
      <div class="jumbotron" style="width:1199px; margin-top:100px; margin-left:75px; background-color: #ffffff;border-radius:15px;border:2px solid #000000;box-shadow:  1px 1px 15px 1px  #000000">
         ...
         <!--?php include 'mensagem.php'; ?-->
            ...
            <!-- Form Name -->
            <legend style="background-color:#000000;border-radius:5px;margin-top:-50px;width:1199px;margin-left:-32px;color:#ffffff"> <b>Confirmation of User</b></legend></fieldset>
                     ...
                     <label class="control-label" style="text-align:right; ">Project:</label>
                      <div class="input"  style="margin-bottom:-1%;" >
                        ...
                        <label class="checkbox" style="margin-left:-1px;font-weight: bold;">
                                   DES<input  name="project[]" id="DES" value="DES" type="checkbox"  style="padding-left:30px;" <?php if($projects[0] == 'DES'){ echo "checked"; } ?>></label>
                        </div><br>
                        <div class="input">
                        <label class="checkbox" style="margin-left:212px;position:initial;margin-bottom:30px;">
                           <input name="project[]"  id="SDSS-IV" value="SDSS-IV" type="checkbox" <?php if($projects[1] =='SDSS-IV'){ echo "checked"; } ?>>SDSS-IV
                        </label>
                     </div></label>
                     </div></label>
