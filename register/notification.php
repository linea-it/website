...
$message .="<html><head>  
        ...
        <table id='notification' cellspacing='0'>
            <thead>
                <tr><th style='padding-left:210px;background-color:#727272;' colspan='1' >APPROVAL OF REGISTRATION</th></tr>
            </thead>
            ...
            $message .="<tr><td></td></tr>";
                ...
                $array_user = mysql_fetch_array($select_user); 
                    ...
                    $message .="<tr>";
                    $message .="<td>Dear $name, you was approved in LineA.</td></tr>";
                	  //$message .="<td><p class='align'></p></td><";

                	$message .="<tr><td>Your user of LIneA is : $user_linea .</td></tr>";
                	//$message .="<td><p class='align'>'".$user_of_linea ."'</p></td>";
            		  //$message .="</tr>";

                  /*$message .= "<tr><td>Porject:";
                      $p=0;
                      for ($p=1; $p<=2; $p++) { 
              
                       $query_project = ("SELECT name from project as p left JOIN link_project as lp  on lp.fk_user_id='".$id."'  where  lp.fk_user_id='".$id."' and p.id='".$p."'") or die(mysql_error()); 
                
                           $select_project= mysql_query($query_project);
			...
			<tfoot>
                <tr>
                    <th style='margin-left-250px;background-color:#727272;' colspan='4' >
                        ...
                        <span style='font-size:13px;color:#CCCCCC;'> Dúvidas ou ajuda entre em contato com o <a href='mailto:ana.marcela@linea.gov.br'><font color='#cccccc'>Help Desk</font></a></span></th>
                </tr>
